...
It uses react-router, pinia, tailwind and [@kobbleio/react(https://www.npmjs.com/package/@kobbleio/auth-spa-js) SDK to manage the authentication state of the application.
...
<Note>
    This guide uses our @kobbleio/react SDK. To use a lower-level SDK such as @kobbleio/auth-spa-js, check our [React SPA quickstart guide](/learning/quickstart/react-auth-spa-js).
</Note>
